# From https://github.com/compmodels/jupyterhub/blob/master/docker_oauth.py
...
class DockerAuthenticator(LocalAuthenticator):
    ...
    def system_user_exists(self, user):
        ...
        return user.state and user.state.get('user_id', -1) >= 0
...
class DockerDummy(DockerAuthenticator, DummyAuthenticator):
    """A version that mixes in local system user creation from within a
    docker container, and Google OAuthentication.
    """
    pass
